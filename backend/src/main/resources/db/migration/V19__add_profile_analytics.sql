...
CREATE TABLE profile_views (
    ...
    -- Prevent duplicate views in same day (optional - can be removed if you want all views)
...
CREATE TABLE post_views (
    ...
    -- Track unique views per user per post per day
    UNIQUE(post_id, viewer_id, DATE(viewed_at))
);
